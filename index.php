...
<div class="container">
	<form class="form-signin">
		...
		<input id="email" type="text" class="input-block-level" placeholder="Email address" value="" />
		<input id="password" type="password" class="input-block-level" placeholder="Password" value="" />
		<label class="checkbox">
			<input type="checkbox" value="remember-me"> Remember me
		</label>
		<button id="sign-in" class="btn btn-large btn-primary" data-loading-text="Loading..." type="button"></button>
		<br />
		<br />
	...
	function SignIn() {
		...
		signInBtn.addClass('disabled').text('Signing in...');
		  ...
		  $.ajax({
			...
			CWMCommon.SignIn(data, "manage.php");
