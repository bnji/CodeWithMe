...
$results = DB::query("SELECT * FROM CWM_Project as p JOIN CWM_SolutionProject as sp ON p.Id = sp.ProjectId WHERE p.SolutionId = sp.SolutionId AND sp.SolutionId=%?", $solutionId);
$data = array();
