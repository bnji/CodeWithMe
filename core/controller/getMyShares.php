...
$results = DB::query("SELECT sh.Url, f.SolutionName, f.ProjectName, f.Name, f.Data FROM CWM_Share as sh JOIN CWM_File f ON sh.FileId = f.Id WHERE sh.UserId=%?", $_GET['uid']);
$data = array();
