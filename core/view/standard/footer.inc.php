	...
	<script src="<?php echo $GLOBALS['urlLibs']; ?>/external/bootstrap/plugins/button.js"></script>
	<script src="<?php echo $GLOBALS['urlLibs']; ?>/external/bootstrap/plugins/tooltip.js"></script>
